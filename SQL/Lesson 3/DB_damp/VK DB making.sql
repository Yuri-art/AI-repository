...
CREATE TABLE IF NOT EXISTS profiles (
	...
	media_id INT UNSIGNED NOT NULL # Изменил с photo_id на media_id для связи с таблицей media
);
...
CREATE TABLE IF NOT EXISTS friendship (
	...
	status_id INT UNSIGNED NOT NULL, # добавил таблицу статусов
